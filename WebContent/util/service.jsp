...
<head>
<meta charset="UTF-8">
<title>PuppyHome 서비스 이용약관</title>
<link rel="stylesheet" type="text/css" href="../css/service.css"> <%-- service.css --%>
</head>
<body>
<div class="wrap">
	<div class="service_content">
		<div class="service_header">
			<div class="service_titleBox">
     			<span id="service_title">서비스 이용약관</span><br>
     		<div class="service_downloadBox">
     			<div class="service_dateBox">
					<span id="service_date">현행 시행일자 : 2023년 03월 20일</span>
     			</div>
     		</div>
     		</div>
        </div>
        <div class="service_body">
			제1조(목적)<br>
			이 약관은 (주)어바웃펫(전자거래 사업자, 이하 "회사"라 함)가 운영하는 사이버 몰에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br>
			※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」<br><br>
			제2조(정의)<br>
			① "몰"이란 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
			...
			⑤ "어바웃펫TV"이라 함은 몰에서 제공하는 반려동물 영상 콘텐츠를 말합니다.<br>
			⑥ "어바웃펫 LOG"이라 함은 몰에서 제공하는 커뮤니티를 말합니다<br>
			⑦ "게시물"이라 함은 회원이 서비스를 이용함에 있어 "서비스"에 게시한 부호ㆍ문자ㆍ음성ㆍ음향ㆍ화상ㆍ동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일, 링크, 댓글 등을 의미합니다.<br>
			⑧ "적립금"이란 "몰"이 특정 재화 등을 구입한 이용자 또는 경품 등의 목적으로 이용자에게 부여한 사이버머니를 말하여, 적립금 부여 및 사용 등과 관련한 사항은 이 약관 또는 "몰"의 운영정책이 정한 바에 따릅니다.<br>
			⑨ "스탬프"란 "몰" 또는 제3자가 서비스의 원활한 이용을 위해 회원에게 부여하는 재산적 가치 및 환가성 없는 무형의 도구를 뜻하며, "몰"이 지정한 용도 및 사용방법에 따라 이용자가 이용할 수 있는 혜택을 말합니다.<br>
			⑩ "할인쿠폰"이란 일정액 또는 일정비율을 할인 받을 수 있도록 "몰"이 "이용자"에게 지급하는 것을 말합니다.<br>
			⑪ 이 약관에서 사용하는 용어 중 본 조에서 정하지 아니한 것은 서비스 이용 시 제공되는 안내, 관계 법령에서 정하는 바에 따르며, 그 외에는 일반 관례에 따릅니다.<br><br>
			...
			③ "몰"은 전자상거래 등에서의 소비자보호에 관한 법률, 약관의 규제에 관한 법률, 전자문서 및 전자거래기본법, 전자서명법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 방문판매 등에 관한 법률, 소비자기본법 등 관련법을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.<br>
			...
			⑤ "몰"이 약관을 개정할 경우에는 그 개정약관은 그 적용일자 이후에 체결되는 계약에만 적용되고 그 이전에 이미 체결된 계약에 대해서는 개정전의 약관조항이 그대로 적용됩니다. 다만 이미 계약을 체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 제4항에 의한 개정약관의 공지기간내에 "몰"에 송신하여 "몰"의 동의를 받은 경우에는 개정약관 조항이 적용됩니다.<br>
			⑥ 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 전자상거래등에서의 소비자보호에 관한 법률, 약관의 규제 등에 관한 법률, 공정거래위원회가 정하는 전자상거래 등에서의 소비자 보호지침 및 관계법령 또는 상관례에 따릅니다.<br><br>
			제4조(서비스의 제공 및 변경)<br>
			...
			⑤ 기타 GS리테일 멤버십(THE POP) 과 관련한 내용은 GS리테일 멤버십(THE POP) 회원인 이용자에 한하여 당해 약관을 적용합니다.<br><br>
			제5조(서비스의 중단)<br>
			...
			③ 사업종목의 전환, 사업의 포기, 업체 간 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 "몰"은 제8조에 정한 방법으로 이용자에게 통지하고 당초 "몰"에서 제시한 조건에 따라 소비자에게 보상합니다. 다만, "몰"이 보상기준 등을 고지하지 아니한 경우에는 이용자들의 마일리지 또는 적립금 등을 "몰"에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.<br><br>
			제6조(회원가입)<br>
			...
			④ 회원은 회원가입 시 등록사항에 변경이 있는 경우, 즉시 전자우편 기타 방법으로 "몰"에 대하여 그 변경사항을 알려야 합니다.<br><br>
			...
			⑤ 회원이 탈퇴하는 경우, 회원의 정보보호를 위해 탈퇴 신청일로부터 30일 후에 본인정보 및 작성한 게시물은 모두 삭제됩니다. 탈퇴 신청일로부터 30일 동안은 모든 정보와 게시물에 대해 접근이 제한되며 30일 이내에 계정 재사용 요청 시 기존 계정을 이용할 수 있습니다.<br>
			⑥ 회사는 회원이 1년 동안 로그인하지 않은 경우, 휴면계정으로 분류하고 개인정보 파기 조치를 위하여 회원탈퇴 처리할 수 있습니다.<br><br>
			제8조(회원에 대한 통지)<br>
			...
			6. 결제방법의 선택 및 결제<br>
			② "몰"이 제3자에게 이용자 개인정보를 제공할 필요가 있는 경우 1) 개인정보를 제공받는 자, 2)개인정보를 제공받는 자의 개인정보 이용목적, 3) 제공하는 개인정보의 항목, 4) 개인정보를 제공받는 자의 개인정보 보유 및 이용기간을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.)<br>
			③ "몰"이 제3자에게 이용자의 개인정보를 취급할 수 있도록 업무를 위탁하는 경우에는 1) 개인정보 취급위탁을 받는 자, 2) 개인정보 취급위탁을 하는 업무의 내용을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) 다만, 서비스제공에 관한 계약이행을 위해 필요하고 구매자의 편의증진과 관련된 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에서 정하고 있는 방법으로 개인정보 취급방침을 통해 알림으로써 고지절차와 동의절차를 거치지 않아도 됩니다.<br><br>
			제10조 (계약의 성립)<br>
			...
			4. 전자화폐에 의한 결제<br>
			5. 수령 시 대금지급<br>
			6. 마일리지, 적립금 등 "몰"이 지급한 포인트에 의한 결제<br>
			...
			제14조(환급)<br>
			"몰"은 이용자가 구매신청한 재화등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 2영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.<br><br>
			제15조(청약철회 등)<br>
			...
			④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화등의 내용이 표시·광고 내용과 다르거나 계약내용과 다르게 이행된 때에는 당해 재화등을 공급받은 날부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회 등을 할 수 있습니다.<br><br>
			제16조(청약철회 등의 효과)<br>
			...
			제17조(개인정보보호)<br>
			① "몰"은 이용자의 정보수집시 구매계약 이행 및 서비스이용에 필요한 최소한의 정보를 수집합니다. 다음 사항을 필수사항으로 하며 그 외 사항은 선택사항으로 합니다.<br>
			1. 성명<br>
			2. 주소<br>
			3. 전화번호<br>
			4. 희망ID(회원의 경우)<br>
			...
			7. 위치정보(회원이 어바웃펫LOG에 사진 업로드하는 경우)<br>
			...
			④ "몰"이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보 보호책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은 자, 제공목적 및 제공할 정보의 내용) 등 정보통신망 이용촉진등에 관한 법률 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.<br>
			...
			8. 다른 회원을 희롱 또는 위협하거나, 특정 회원에게 지속적으로 고통 또는 불편을 주는 행위<br><br>
			...
			④ "몰"은 회원이 서비스 내에 게시한 게시물이 관련 법령에 위반되거나 음란 또는 청소년에게 유해한 게시물, 차별 갈등을 조장하는 게시물, 도배 · 광고 · 홍보 · 스팸성 게시물, 계정을 양도 또는 거래하는 내용의 게시물, 타인을 사칭하는 게시물 등이라고 판단되는 경우 이를 삭제하거나 게시를 거부할 수 있습니다.<br><br>
			제23조 (개인정보의 목적 외 이용 및 위탁)<br>
			① "몰"은 이용자의 개인정보를 “제 17조 개인정보보호정책” 에서 고지한 범위 내에서 사용하며 동 범위를 초과하여 이용하거나 원칙적으로 제 3자에게 제공하지 않습니다. 다만 다음의 경우에는 합당한 절차를 통한 회원의 동의를 얻어 개인정보를 제공 또는 이용할 수 있습니다.<br>
			② "몰"은 보다 나은 서비스 제공을 위하여 회원의 개인정보를 제휴사에 제공할 수 있습니다. 이 경우 회원에게 개인정보의 항목, 개인정보 제공 목적, 제공기간, 개인정보보호방안 등에 대해서 사전에 개별적으로 동의를 구하는 절차를 거치게 되며, 회원의 동의가 없는 경우에 이를 제공하지 않습니다.<br>
			③ "몰"은 보다 나은 서비스 제공을 위하여 회원의 개인정보를 위탁하여 처리할 수 있으며, 이 경우 반드시 사전에 위탁처리 업체명과 목적, 위탁처리 되는 개인정보의 범위, 위탁기간 등에 대해 상세하게 고지합니다.<br>
			단, 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수사기관의 요구가 있는 경우에는 사전 동의 없이 제공될 수 있습니다.<br><br>
			제24조(분쟁해결)<br>
			...
			제26조(적립금 및 스탬프)<br>
			① 적립금과 스탬프의 부여 및 사용 등과 관련한 사항은 이 약관 또는 "몰"의 운영정책이 정한 바에 따르며, 회사 정책 또는 기타 사정에 따라 수시 변동될 수 있습니다.<br>
			② 적립금의 유효기간은 적립일로부터 60일, 스탬프 유효기간은 적립일 또는 적립금을 스탬프로 전환일(이하 ”전환일”)로부터 365일이며 유효기간 만료 시 자동 소멸됩니다. 구매 후기 작성, 이벤트 등 기타 사유로 인해 지급되는 적립금 및 스탬프는 회사가 별도 명시한 기준에 따라 유효기간이 변경될 수 있습니다.<br>
			③ 반품 등의 청약 철회 시 환급되는 적립금 및 스탬프의 경우 최초 적립을 기준으로 유효기간이 적용됩니다.<br>
			④ 적립금과 스탬프는 유효기간이 임박한 순서로 사용되며, 유효기간이 동일한 경우 적립일자와 전환일자가 빠른 순서대로 사용됩니다. 고지된 유효기간이 경과된 적립금과 스탬프는 자동 소멸됩니다.<br>
			⑤ 이용자는 적립금과 스탬프를 제3자 또는 다른 아이디로 양도할 수 없으며 유상으로 거래하거나 현금으로 전환할 수 없습니다.<br>
			⑥ "몰"은 이용자가 "몰"이 승인하지 않은 방법 또는 허위 정보 제공, 본 약관에 위배되는 등의 부정한 방법으로 적립금이나 스탬프를 사용하는 경우 어바웃펫 적립금과 스탬프의 사용을 제한 또는 "몰"이 정한 방법으로 회수할 수 있으며, 적립금이나 스탬프를 사용한 구매신청을 취소하거나 이용자 자격을 정지할 수 있습니다.<br>
			⑦ 이용자 탈퇴 시 사용하지 않은 적립금과 스탬프는 즉시 소멸되며, 탈퇴 후 재가입하더라도 소멸된 적립금과 스탬프는 복구되지 않습니다.<br><br>
			제27조(할인쿠폰)<br>
			① "몰"은 직접 또는 제3자를 통하여 사용 대상, 사용 방법, 사용 기간, 사용 조건, 할인금액 등을 정하여 이용자가 사이버몰에서 사용할 수 있는 할인쿠폰을 발행할 수 있습니다. 할인쿠폰의 구체적인 종류나 내용은 이 약관 또는 "몰"의 운영정책이 정한 바에 따르며, 회사 정책 또는 기타 사정에 따라 달라질 수 있습니다.<br>
			② "몰"은 할인쿠폰을 발행함에 있어 사용 방법, 사용 기간, 사용 조건, 할인 금액(또는 할인율) 등을 별도로 표시하거나 통지합니다.<br>
			③ 할인쿠폰은 현금으로 환급될 수 없으며, 할인쿠폰의 사용기간이 만료되거나 구매 취소 시 또는 이용계약이 종료되면 소멸됩니다.<br>
			④ 이벤트 등을 통하여 제공된 할인쿠폰은 "몰"이 별도로 정한 사용기간이 있을 경우 이 기간 내에 사용하여야 하며, 어떠한 경우에도 현금으로 환불되거나 재발급되지 않습니다.<br>
			⑤ "이용자"는 할인쿠폰을 제3자 또는 다른 아이디로 양도 또는 합산할 수 없으며, 유상으로 거래하거나 현금으로 전환할 수 없습니다.<br>
			⑥ "몰"은 "이용자"가 부정한 방법으로 할인쿠폰을 취득하거나 사용한 사실이 확인될 경우, 할인쿠폰의 사용 제한, 할인쿠폰 회수, 할인쿠폰을 사용한 구매 계약 취소 또는 회원 자격 정지/상실 등의 조치를 취할 수 있고, 이용자의 행위로 인하여 몰에게 발생한 손해의 배상을 청구할 수 있습니다.<br><br>
			부칙<br>
			이 약관은 2023년 03월 20일부터 적용됩니다.<br>
		</div>
	</div>
</div>
</body>
