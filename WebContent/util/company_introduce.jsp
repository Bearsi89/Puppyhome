...
<title>PuppyHome 회사소개</title>
<link rel="stylesheet" type="text/css" href="../css/company_introduce.css"> <%-- company_introduce.css --%>
</head>
<body>
	<div id="wrap">
		<div class="container">
			<div class="header">
				...
				<div class="imgBox">
					<img src="../images/crying_lion.png" id="crying_lionImg" alt="우는 라이언">
				</div>
			</div>
			<div class="content">
